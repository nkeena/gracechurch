    ...
    <div class="container flex justify-between items-center">
        <a href="/" class="no-underline font-bold text-blue flex items-center text-2xl">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" width="50" height="50" class="mr-2">
                <path class="fill-current" d="M499.9,462.2V538h156c-4.6,19.1-12.7,37.2-24.1,53.7c-50.5,72.7-150.7,90.8-223.4,40.3
            ...
            <div>Grace <span class="text-black">Church</span></div>
        </a>

        <nav class="md:flex items-center hidden">
            <a href="/about" class="text-black uppercase font-bold tracking-wide no-underline text-sm hover:text-blue block p-2">About</a>
            <a href="/contact" class="text-black uppercase font-bold tracking-wide no-underline text-sm hover:text-blue block p-2">Contact</a>
            <a href="https://subsplash.com/gracesanantonio/messages" target="_blank" class="text-black uppercase font-bold tracking-wide no-underline text-sm hover:text-blue block p-2">Messages</a>
            <a href="/give" class="text-black uppercase font-bold tracking-wide no-underline text-sm hover:text-blue block p-2">Give</a>
